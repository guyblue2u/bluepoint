...
var mainScene = new Phaser.Class({
    ...
    create: function () {
        ...
        this.anims.create({
            ...
            repeat: -1,
            frameRate: 3,
            frames: this.anims.generateFrameNumbers('ZZZ', {
                frames: [0, 1]
            })
        })
        ...
        this.anims.create({
            ...
            repeat: -1,
            frameRate: 1,
            frames: this.anims.generateFrameNumbers('discoBall', {
                frames: [0, 1]
            })
        })
        ...
        timedEvent = this.time.delayedCall(144000 + initialTime, () => {
            player.avatar.play("collapse" + player.shirt);
