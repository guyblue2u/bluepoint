...
load_files_level_1 = function (scene) {
    ...
    scene.load.spritesheet("redGuy", "./assets/images/level_1/red guy blue sprites.png", {
        frameWidth: 36,
        frameHeight: 36
    }); // blue character
    scene.load.spritesheet("collapsingRed", "./assets/images/level_1/collapsing_red.png", {
        frameWidth: 36,
        frameHeight: 36
    });
    ...
    scene.load.spritesheet("NPC", "./assets/images/level_1/NPC sprites.png", {
        frameWidth: 36,
        frameHeight: 36
    }); // NPC
    scene.load.spritesheet("ZZZ", "./assets/images/level_1/white z.png", {
        frameWidth: 36,
        frameHeight: 36
    }); // zzz when sleeping
    ...
    scene.load.spritesheet("ZZZIcon", "./assets/images/level_1/white z.png", {
        frameWidth: 36,
        frameHeight: 36
    });
...
load_files_level_2 = function (scene) {
    ...
    scene.load.spritesheet("footsteps", "./assets/images/level_2/footsteps.png", {
        frameWidth: 6,
        frameHeight: 6
    });
    ...
    scene.load.spritesheet("level2_beerCrane", "./assets/images/level_2/beer crane 39x64.png", {
        frameWidth: 39,
        frameHeight: 64
    });
    scene.load.spritesheet("level2_beer", "./assets/images/level_2/beer 32x32.png", {
        frameWidth: 32,
        frameHeight: 32
    });

    scene.load.spritesheet("arrows_mobile", "./assets/images/level_2/arrows_mobile.png", {
        frameWidth: 50,
        frameHeight: 57
    });
...
load_files_intro = function (scene) {
    ...
    //--------- Intro
     scene.load.video('background_intro_1', './assets/videos/file_example_WEBM_480_900KB.webm');
